Antes de nada se recomienda repasar los conceptos dados en [Control de un servomotor](https://fgcoca.github.io/Conceptos-de-referencia-para-las-guias-fundamentales/previos/#control-de-un-servomotor) y el uso de las listas de datos.
...
!!! info "==**IMPORTANTE**=="
	...
	![Logotipo steamakersblocks](../img/steamakers/steamakersblockslogo.png)
