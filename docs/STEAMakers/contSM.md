...
Esta placa puede programarse mediante diversas plataformas y lenguajes, como Arduino IDE con código basado en C/C++ o entornos de programación visual STEAMakersBlocks y MicroBlocks.
...
### <FONT COLOR=#AA0000>STEAMakersBlocks</font>
STEAMakersBlocks [http://www.STEAMakersBlocks.com](http://www.STEAMakersBlocks.com/) es un entorno de programación visual por bloques que facilita la programación de la placa.

STEAMakersBlocks es compatible con varias placas electrónicas. En su entorno de programación o IDE se pueden distinguir las siguientes partes:

![Entorno de programación o IDE de STEAMakersBlocks](../img/uno/IDE_AB.png)  
...
Para poder conectar y programar las placas con STEAMakersBlocks, es necesario instalar "Connector” para permitir la comunicación entre el entorno STEAMakersBlocks y la placa electrónica.

En "Recursos" de "STEAMakersBlocks" tenemos todas las opciones de descarga y condiciones de instalación de “Connector” para los sistemas operativos soportados. Para el caso de Ubuntu nos indica:

![Connector](../img/uno/Connector.png)  

Una vez instalado lo podemos encontrar entre las aplicaciones:

![Connector](../img/uno/Connector_app.png)  

Al abrir Connector, aparece este cuadro de diálogo que va mostrando información sobre la placa y STEAMakersBlocks:

![Connector en ejecución](../img/uno/Connector_eje.png)  

Dejamos Connector en ejecución minimizado en segundo plano.
!!! Info "IMPORTANTE:"
    !!! Example ""
    Las imágenes pueden no corresponderse con la plataforma STEAMakersBlocks porque fueron capturadas cuando se llamaba ArduinoBlocks, pero básicamente el cambio será estará en el logotipo.
...
![Pantalla inicial STEAMakersBlocks](../img/uno/pant_ini_AB.png)  
...
!!! Success "Nuevas formas de acceso:"
    ...
    !!! Question ""
        ...
        ![Pantalla Alternativas de acceso a STEAMakersBlocks](../img/uno/pant_ini_accesos.png)
        

<FONT size=9><FONT COLOR=#FF0055><b>2. </b></font></font> Al entrar en la plataforma te encontrarás esta pantalla:

![Sesión iniciada en STEAMakersBlocks](../img/uno/ses_ini.png)  
...
<FONT size=9><FONT COLOR=#FF0055><b>3.</b></font></font> Una vez configurado el entorno, vamos a programar el envío en bucle de un mensaje por puerto serie. Copiamos el código del programa de STEAMakersBlocks y quedaría así:

![Programa Hola mundo](../img/steamakers/IDE_holamundo.png)  

Se ha cambiado el tiempo a un segundo para asegurarnos que el programa es diferente al de STEAMakersBlocks. Este es el código del programa listo para copiar:
...
Se trata de crear un programa que muestre en la consola serie de STEAMakersBlocks un mensaje con el texto "Hola desde ESP32 STEAMakers. Tiempo transcurrido nn segundos" cada cinco segundos. Cada mensaje debe aparece en una línea diferente.
